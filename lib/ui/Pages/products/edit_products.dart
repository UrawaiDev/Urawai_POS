...
class _EditProductPageState extends State<EditProductPage> {
  ...
  void initState() {
    super.initState();
    _textProductName.text = widget.product.name;
    _textProductPrice.text = widget.product.price.toString();
    _textDiscount.text = widget.product.discount.toString();
    _categoryValue = widget.product.category;
    _isPopular = widget.product.isRecommended;
  }
                            ...
                            child: Column(
                              children: <Widget>[
                                ...
                                Row(
                                  ...
                                  children: <Widget>[
                                    CostumButton.squareButtonSmall('Gallery',
                    ...
                    if (_formKey.currentState.validate()) {
                      ...
                      if (result == true) {
                        CostumDialogBox.showDialogInformation(
                            ...
                            title: 'Informasi',
                            contentText: 'Produk telah diupdate.',
                            onTap: () => Navigator.pushNamed(
                                  context,
                                  RouteGenerator.kRouteProductListPage,
                                ));
                      }
                    }
                  }),
